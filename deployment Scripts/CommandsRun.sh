...
# Not needed for ubuntu
        ...
        # Need to intstall mysql. Since we are using Debian we need to install gnupg first
        # Following this doc: https://www.digitalocean.com/community/tutorials/how-to-install-the-latest-mysql-on-debian-10
        sudo apt install gnupg
        wget https://dev.mysql.com/get/mysql-apt-config_0.8.22-1_all.deb

        # Follow the prompt here to install mysql server 8.0
        sudo dpkg -i mysql-apt-config*
        # update everything again 
        sudo apt update

# Install sql and don't enter a password to keep it simple for this app. May change later
...
cd /opt
sudo git clone https://github.com/dasha91/JavaDemoApp
